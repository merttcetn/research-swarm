...
Dispatch independent workers concurrently. Instruct workers not to delegate further and not to modify source files. A worker may write only its assigned report artifact.
...
Spawn one fresh synthesis subagent. Give it:
